# Using Clawd Code Skills with Windsurf
...
cat skills/test-driven-development/SKILL.md > .windsurfrules
echo "\n---\n" >> .windsurfrules
cat skills/incremental-implementation/SKILL.md >> .windsurfrules
echo "\n---\n" >> .windsurfrules
cat skills/code-review-and-quality/SKILL.md >> .windsurfrules
```
...
```
# .windsurfrules
# Essential Clawd Code skills for this project
