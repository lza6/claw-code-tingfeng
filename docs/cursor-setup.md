# Using Clawd Code Skills with Cursor
...
cp skills/test-driven-development/SKILL.md .cursor/rules/test-driven-development.md
cp skills/code-review-and-quality/SKILL.md .cursor/rules/code-review-and-quality.md
cp skills/incremental-implementation/SKILL.md .cursor/rules/incremental-implementation.md
```
...
cat skills/test-driven-development/SKILL.md > .cursorrules
echo "\n---\n" >> .cursorrules
cat skills/code-review-and-quality/SKILL.md >> .cursorrules
```
