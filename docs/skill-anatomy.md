...
This document describes the structure and format of skill files. Use this as a guide when contributing new skills or understanding existing ones.
...
**Good:** "Run `python -m pytest tests/ -v` and verify all tests pass"
...
2. **Specific over general.** "Run `python -m pytest`" beats "verify the tests".
