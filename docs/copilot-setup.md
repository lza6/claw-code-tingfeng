# Using Clawd Code Skills with GitHub Copilot
...
cat skills/test-driven-development/SKILL.md > .github/copilot-instructions.md
echo "\n---\n" >> .github/copilot-instructions.md
cat skills/code-review-and-quality/SKILL.md >> .github/copilot-instructions.md
```

### Agent Personas (agents.md)

Copilot supports specialized agent personas. Use the Clawd Code agents:

```bash
# Copy agent definitions
cp agents/code-reviewer.md .github/agents/code-reviewer.md
cp agents/test-engineer.md .github/agents/test-engineer.md
cp agents/security-auditor.md .github/agents/security-auditor.md
```
...
- Run `python -m pytest tests/ -v --tb=short` after every change

## Code Quality
- Review across five axes: correctness, readability, architecture, security, performance
- Every PR must pass: lint (ruff), tests (pytest), build
